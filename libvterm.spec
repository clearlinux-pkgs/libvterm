...
Source0  : https://www.leonerd.org.uk/code/libvterm/libvterm-0.3.3.tar.gz
...
%prep
%setup -q -n libvterm-0.3.3
cd %{_builddir}/libvterm-0.3.3
pushd ..
cp -a libvterm-0.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701093957
